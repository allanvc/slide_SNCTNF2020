...
- impossibilidade de fiscalizar o serviço prestado por BB e CEF ao FIES

- junto às faturas, vinham bases com dados dos alunos financiados (~ 1,7 milhão de linhas cada)
...
- mensal: ~ R$ 40 milhões cada

- anual: ~ 1 bilhão de reais
...
<!-- - impossibilidade de identificar irregularidades nas bases de dados e na cobrança -->
...
Assessoria técnica vinculada à Assessoria de Gestão Estratégica/Presidência
]
...
I) propor metodologias estatístico-computacionais para subsidiar projetos estratégicos e
sensíveis;

II) acompanhar atividades que envolvam os temas de análise de dados e modelagem
estatístico-computacional no âmbito do FNDE;

III) atuar na proposição, acompanhamento e revisão dos indicadores.
...
- FNDE é responsável pela descentralização de recursos de cerca de 33 programas (5.570 municípios, 27 estados + entidades)
...
- as escolas não tem obrigação de informar número de alunos
...
<p>
<a href="https://allanvc.github.io/slide_WIDaT2019/" style="color:navyblue">https://allanvc.github.io/slide_SNCTNF2020/</a>
</p>
